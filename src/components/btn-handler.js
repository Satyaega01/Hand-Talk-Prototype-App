...
const ButtonHandler = ({ imageRef, cameraRef, videoRef }) => {
  ...
  return (
    <div className="btn-container">
      ...
      >
        <img className="icon-button" src={require("../assets/icon/Kamera.png")} />
        Deteksi Langsung
      </button>
      ...
      >
        <img className="icon-button" src={require("../assets/icon/Gambar.png")} />
        Deteksi Gambar
      </button>
      ...
      >
        <img className="icon-button" src={require("../assets/icon/Gambar.png")} />
        {streaming === "video" ? "Close" : "Deteksi"} Video
      </button> */}
      <button>
        {" "}
        <img className="icon-button" src={require("../assets/icon/Kamus.png")} /> Kamus BISINDO
      </button>
    </div>
  );
};
